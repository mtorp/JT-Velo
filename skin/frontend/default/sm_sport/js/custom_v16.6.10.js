...
(function($,sr) {
  ...
  //     	if (md.mobile() == null) {
  //     		$("body").find('.slick-slider .slick-slide:nth-child(1n+3) video').attr("preload", true);
  //     		$("body").addClass("device-desktop");
  //     		setTimeout(function(){
  //     			$("body").find('.slick-slider .slick-slide:nth-child(2) video').get(0).play();
  //     		},2000);
  //     	} else {
  ...
  //   	// On before slide change
		...
		// 	// Stop all videos except the 1st
		// 	$('.slick-slider .slick-slide:nth-child(1n+3) video').each(function(){
		// 		$(this).get(0).pause();
		// 	});
