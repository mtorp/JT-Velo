...
Lightcheckout = Class.create({
    ...
    LightcheckoutSubmit: function () {
		...
		var input_post = $('s_method_postdk_postdk_34');
		if(typeof input_post != 'undefined' && input_post != null)
		{
			if(input_post.checked)
			{
				var droppointId = $('pacsoft-droppoint-id');
				if($('pacsoft-droppoint-id').value == "")
				{
					alert('Vælg venligst afhentningssted');
					var btn = $('pickup_location_btn');
